...
from ui_widgets import (ModernButton, ModernCard, ModernLabel, ModernEntry,
                                 ModernCombobox, StatusIndicator, ModernProgressBar)
...
class VoiceControlApp:
    ...
    def __init__(self, root):
        self.root = root
           ...
           self.root.configure(bg=MODERN_COLORS["bg_secondary"])
